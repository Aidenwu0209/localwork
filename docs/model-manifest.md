...
- Bootstrap URLs pin repository revisions (ThinkingCap `0982db1b`, Gemma
  `b8093469`, MiniCPM-V `78e02f06`, MiniCPM5 `87007042`, Qwen embed
  `370f27d7`) and finish with `sha256sum -c`.
- Production set verified 2026-07-20. P3.1 adds two benchmark quants from the
  same pinned repository; their source LFS SHA256 values are pinned below and
  the bootstrap verifies them locally. Expected complete set: 12 files · ≈81 GB.
...
| brain (P3.1 benchmark) | 〃 | `ThinkingCap-Qwen3.6-27B-Q6_K.gguf` | 22.4G | `37d93cb02a08e42a2b8e917d79efc340709b90546cac1fa655121ccadf4aa791` |
| brain (P3.1 benchmark) | 〃 | `ThinkingCap-Qwen3.6-27B-Q4_K_M.gguf` | 16.8G | `b0651e28555bde7d2459ce99f091319b1a547143463e8d49f2aa7f572675fe67` |
