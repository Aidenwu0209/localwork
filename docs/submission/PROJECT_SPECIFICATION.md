...
- The accepted evidence cut remains unchanged at **2:37** (157.2 seconds). The submission package adds a **3:15.2 English-primary** cut with authentic evidence slides, the unchanged live-run visuals, replacement English narration, and an editable full-length SRT. It is within the official **3–5 minute** window.
...
- [x] Original 2:37 evidence cut retained; 3:15.2 English-primary submission cut and editable SRT supplied within the official 3–5 minute window.
...
- Accepted implementation and demo proof: `docs/verification-log.md`; the memoryd pipeline and Honcho projection modules; `tests/release/test_release_contract.py`; and `docs/assets/demo/p34-video-manifest.json` with the immutable accepted evidence MP4 and the English-primary 3:15.2 submission MP4.
